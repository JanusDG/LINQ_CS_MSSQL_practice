    ...
    static void Main()
    {
        ...
        if (int.TryParse(taskNumber, out int taskNumberInt))
        {
            if (taskNumberInt >= 1 && taskNumberInt <= 30)
            {
                ...
                using (TasksService._context)
                {
                    TasksService._context.Database.EnsureCreated();
                    ...
                    switch (taskNumberInt)
                    {
                        case 1:
                            using (TasksService._context)
                            {
                                ...
                                for (int i = 0; i < 10; i++)
                                {
                                    ...
                                    var existingEntry = TasksService._context.Task1NumbersTable.FirstOrDefault(t => t.Value == i);
                                    if (existingEntry == null)
                                    {
                                        TasksService._context.Task1NumbersTable.Add(new Task1Number { Value = i }); 
                                    }
                                }

                                TasksService._context.SaveChanges();
                                Console.WriteLine("All number entries: ");
                                TasksService._context.Task1NumbersTable
                                    .Select(n => n.Value)
                                    .ToList()
                        ...
                        case 2:
                            using (TasksService._context)
                            {
                                ...
                                TasksService._context.Task1NumbersTable.Where(t => t.Value > 0)
                                    .Where(t => t.Value <= 11)
                                    .Select(n => n.Value)
                                    .ToList()
                                    .ForEach(Console.WriteLine);
                        ...
                        case 4:
                            using (TasksService._context)
                            {
                                ...
                                for (int i = 1; i <= 10; i++)
                                {
                                    ...
                                    {
                                        TasksService._context.Task4NumbersTable.Add(new Task4Number { Value = i });
                                    }
                                }

                                TasksService._context.SaveChanges();
                                Console.WriteLine("All number entries: ");
                                TasksService._context.Task4NumbersTable
                                    .Select(n => n.Value)
                                    .ToList()
                                    .ForEach(Console.WriteLine);
                        ...
                        case 5:
                            using (TasksService._context)
                            {
                                ...
                                foreach (char c in alphabet)
                                {
                                    ...
                                    for (int j = 1; j <= randomFrequency; j++)
                                    {
                                        TasksService._context.Task5SymbolsTable.Add(new Task5Symbol { Value = c.ToString() });
                                    }
                                }

                                TasksService._context.SaveChanges();
                                Console.WriteLine("All symbol entries: ");
                                TasksService._context.Task5SymbolsTable
                                    .ToList()
                                    .ForEach(Console.WriteLine);
                        ...
                        case 6:
                            using (TasksService._context)
                            {
                                ...
                                for (int i = 1; i <= 7; i++)
                                {
                                    ...
                                    var existingEntry = TasksService._context.Task6DatesTable.FirstOrDefault(t => t.Value == new DateTime(2025, 2, i));
                                    if (existingEntry == null)
                                    {
                                        TasksService._context.Task6DatesTable.Add(new Task6Date { Value = new DateTime(2025, 2, i) });
                                    }
                                }

                                TasksService._context.SaveChanges();
                                Console.WriteLine("All date entries: ");
                                TasksService._context.Task6DatesTable
                        ...
                        case 8:
                            using (TasksService._context)
                            {
                                ...
                                for (int j = 1; j <= 3; j++)
                                {
                                    ...
                                    TasksService._context.Task8StringsTable.Add(new Task8String { Value = word });
                                }


                                TasksService._context.SaveChanges();
                                Console.WriteLine("All word entries: ");
                                TasksService._context.Task8StringsTable
                                    .Select(w => w.Value)
                                    .ToList()
                                    .ForEach(Console.WriteLine);
                        ...
                        case 9:
                            using (TasksService._context)
                            {
                                ...
                                Console.WriteLine("All number entries: ");
                                TasksService._context.Task1NumbersTable.Select(n => n.Value)
                                    .ToList()
                                    .ForEach(Console.WriteLine);
                        ...
                        case 10:
                            using (TasksService._context)
                            {
                                ...
                                {
                                    var firstNEntries = TasksService._context.Task1NumbersTable
                                        .Take(howMuchToTake);
